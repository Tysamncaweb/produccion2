...
#                print ret
    ...
    get_date_document = fields.Date(compute='_get_date_document', method=True, string='Document date', help="")
    get_date_invoice = fields.Date(compute = '_get_date_invoice', method=True, string='Invoice date', type='date',
            help="")
    get_partner_name = fields.Date(compute='_get_name', method=True, string='Partner Name', type='char',
            help="")
    get_partner_vat = fields.Char(compute='_get_vat', method=True, string='Partner vat', type='char',
            help="")
    get_reference = fields.Char(compute='_get_inv_number', method=True, string='Invoice number', type='char',
            help="")
    get_number = fields.Char(compute='_get_control_number', method=True, string='Control number',
            type='char', help="")
    get_total = fields.Float(compute='_get_total', method=True, string='Invoice total', type='float',
            help="")
    get_wh_number = fields.Char(compute='_get_wh_number', method=True, string='Wh document number',
            type='char', help="")
    get_doc = fields.Char(compute='_get_doc', method=True, string='Transaction Type', type='char',
            help="")
    get_t_doc = fields.Char(compute='_get_t_doc', method=True, string='Document Type', type='char',
            help="")
    get_parent = fields.Char(compute='_get_invoice_affected', method=True, string='Parent invoice',
            type='char', help="")
    get_v_sdcf = fields.Float(compute='_get_v_sdcf', method=True, string='SDCF', type='float', help="")
    get_v_exent = fields.Float(compute='_get_v_exent', method=True, string='Amount excempt', type='float',
            help="")
    get_tax_line = fields.Char(compute='_get_inv_tax_line', method=True, string='Tax line', type='char',
            help="")
        #   'get_parent': fields.function(_get_parent, method=True,
        #       string='kind of document', type='char', help=""),
    get_lang = fields.Char(compute='_get_lang', method=True, string='Language', type='char',
            help="")
    get_taxes = fields.Char(compute='_get_taxes', method=True, string='Invoice Taxes', type='char',
            help="")
    get_papel_anulado= fields.Char(compute='_get_papel_anulado', method=True, string='Transaction type',
            type='char', help="")
    get_nro_inport_form = fields.Char(
            _get_nro_inport_form, method=True, string='Import form number',
            type='char', help="")
    get_nro_inport_expe = fields.Char(compute='_get_nro_inport_expe', method=True, string='Import file number',
            type='char', help="")
    get_vat_subjected = fields.Boolean(compute='_get_vat_subjected', method=True, string='Vat subjected',
            type='boolean', help="")
    get_debit_affected = fields.Char(compute='_get_debit_affected', method=True, string='Debit notes affected',
            type='char', help="")
    get_credit_affected = fields.Char(compute='_get_credit_affected', method=True, string='Credit notes affected',
            type='char', help="")
    get_import_form = fields.Char(compute='_get_reference', method=True, string='kind of document',
            type='char', help="")
    get_import_exp = fields.Char(compute='_get_nro_inport_expe', method=True, string='kind of document',
            type='char', help="")
    get_is_imported = fields.Boolean(compute='_get_is_imported', method=True, string='Is an import',
            type='boolean', help="")
    get_date_imported = fields.Date(compute='_get_date_imported', method=True, string='Imported date',
            type='date', help="")
    get_date_invoiced = fields.Date(compute='_get_date_invoiced', method=True, string='Invoiced date',
            type='date', help="")
    get_import_spreadsheets = fields.Date(compute='_get_import_spreadsheets', method=True,
            string='Import spreadsheets', type='date', help="")
    get_invoice_printer = fields.Char(compute='_get_invoice_printer', method=True,
            string='Fiscal printer invoice number', type='char', help="")
    get_fiscal_printer = fields.Char(compute='_get_fiscal_printer', method=True, string='Fiscal machine number',
            type='char', help="")
