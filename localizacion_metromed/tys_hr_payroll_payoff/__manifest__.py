...
Permite generar las nominas de liquidacion de los empleados
    ...
    'depends': ['hr_payroll','tys_hr_special_payroll','hr_config_parameter','hr_contract_add_fields'],
    'data': ['views/hr_payroll_payoff_view.xml','views/hr_contract_liq_fields_view.xml'],
    #'demo': [],
    #'test': [],
    'installable': True
