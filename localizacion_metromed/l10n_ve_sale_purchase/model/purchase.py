...
class PurchaseOrderLine(models.Model):
    ...
    def product_id_change(self, pricelist, product, qty, uom,
        ...
        res = super(PurchaseOrderLine, self).product_id_change(self,
             pricelist, product, qty, uom, partner_id, date_order,
        ...
        if not product:
            ...
            return res
        prod_brw = self.env['product.product'].browse( product)
